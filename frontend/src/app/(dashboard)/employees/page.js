                ...
                filteredEmployees.map((employee) => (
                  <tr key={employee._id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-full bg-emerald-600 flex items-center justify-center text-white text-xs font-semibold">{employee.name?.charAt(0).toUpperCase()}</div>
                    ...
                    {/* Employee ID */}
                    <td className="px-4 py-3">
                      <span className="text-sm text-slate-700">{employee.employeeId}</span>
                    </td>
                    ...
                    {/* Salary */}
                    <td className="px-4 py-3">
                      <span className="font-semibold text-blue-600 text-sm">₹{employee.salaryStructure?.basicSalary?.toLocaleString() || "0"}</span>
                    </td>
