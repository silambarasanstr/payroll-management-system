  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <select value={selectedEmployeeId} onChange={(e) => setSelectedEmployeeId(e.target.value)} className="border rounded-md px-3 py-2 w-72">
          {employees.map((emp) => (
          ...
          <table className="min-w-full">
            ...
            <tbody className="divide-y divide-slate-100">
              {attendanceRecords.map((record) => (
                <tr key={record._id} className="hover:bg-slate-50 text-slate-600">
